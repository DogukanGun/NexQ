...
@HiltViewModel
class LoginVM @Inject constructor() : BaseVM<LoginVS>(LoginVS.Default) {
            ...
            is CustomCredential -> {
                if (credential.type == GoogleIdTokenCredential.TYPE_GOOGLE_ID_TOKEN_CREDENTIAL) {
                    try {
                        ...
                        val id = credential.data.getString("com.google.android.libraries.identity.googleid.BUNDLE_KEY_ID_TOKEN")
