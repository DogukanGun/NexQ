...
import com.dag.nexq_app.presentation.userop.domain.model.UserAuthMethod
...
fun Login(
    ...
    Column(
        ...
        ActionButtons(buttonState = buttonState) {
            ...
            } else if (it == UserAuthMethod.GoogleAuth) {
...
fun ActionButtons(
    buttonState: State<Int>,
    onClick: (userAuthMethod:UserAuthMethod) -> Unit
) {
    Column(
        ...
        CustomButton(
            ...
            onClick(
                if (buttonState.value == R.string.userops_login_radio_button) UserAuthMethod.Login
                else UserAuthMethod.Register
            )
        }
        Divider(
            modifier = Modifier.padding(16.dp),
        ...
        GoogleButton(
            ...
            onClick(UserAuthMethod.GoogleAuth)
        }
    }
}
